...
export const ENDPOINTS = {
  ...
  /* ✅ 2026-08-21 신설. 명세 36건에 없던 것이라 API ID 는 우리가 붙인 임시값이다.
     둘 다 비밀번호를 같이 받는다 — 토큰만으로 바꾸거나 지우게 두면 토큰이 새는 순간 끝이다. */
  'NOW-MY-002': {
    ...ep('auth', 'PATCH', '/me/password', '비밀번호 변경'),
    live: true,
  },
  'NOW-MY-003': { ...ep('auth', 'DELETE', '/me', '회원 탈퇴'), live: true },
  ...
  /* ── 요구사항 No.27 · 첫 발자국·기록 3건 (김민정) ──
     ...
     ✅ 기록 2건도 열렸다(2026-08-20 저녁). 아래 NOW-LOG-001·002 참고. */
