...
const INSET = [534, 475, 418, 377, 309, 272, 210, 149, 62, 23, 0, 0, 0, 23, 62, 149, 210, 272, 309, 377, 418, 475, 534]

// 위 → 아래 색 순서 (오른쪽 장식 기준). 왼쪽 장식은 뒤집어 쓴다.
const COLORS = [
  '#764413', '#764413', '#764413', '#764413', '#764413', '#764413', '#764413', '#764413',
  'rgba(118,68,19,.9)', 'rgba(118,68,19,.9)', 'rgba(118,68,19,.8)',
  '#916942',
  'linear-gradient(#CAA491,#764413)',
  '#CAA491', '#CAA491',
  '#D6BAA2', '#D6BAA2',
  '#E7D7BE', '#E7D7BE', '#E7D7BE',
  '#F3E7D7', '#F3E7D7', '#F3E7D7',
]
